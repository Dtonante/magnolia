const formulario = document.getElementById('ordenMedicaForm')
...
const validateInputs = () =>{
    ...
    if(tipoIdentificacionValue === ""){
        setError(tipoIdentificacion, 'No puedes dejar este campo vacio.')
    }else if(!validarNumero(tipoIdentificacionValue)){
        setError(tipoIdentificacion, 'No se permiten caracteres especiales.')
    }else{
        setSuccess(tipoIdentificacion)
    }
